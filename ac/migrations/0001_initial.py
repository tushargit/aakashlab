...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ac_coordinator', (
            ...
            ('contact', self.gf('django.db.models.fields.IntegerField')(max_length=12, blank=True)),
        ...
        db.create_table(u'ac_project', (
            ...
            ('summary', self.gf('django.db.models.fields.TextField')(unique=True, max_length=500)),
            ('src_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ...
        # Adding M2M table for field member on 'Project'
        m2m_table_name = db.shorten_name(u'ac_project_member')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'ac.project'], null=False)),
            ('teammember', models.ForeignKey(orm[u'ac.teammember'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'teammember_id'])

        # Adding M2M table for field mentor on 'Project'
        m2m_table_name = db.shorten_name(u'ac_project_mentor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'ac.project'], null=False)),
            ('mentor', models.ForeignKey(orm[u'ac.mentor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'mentor_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field member on 'Project'
        db.delete_table(db.shorten_name(u'ac_project_member'))

        # Removing M2M table for field mentor on 'Project'
        db.delete_table(db.shorten_name(u'ac_project_mentor'))
