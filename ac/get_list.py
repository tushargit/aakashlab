...
def get_ac_name_list(max_results=0, starts_with=''):
    if starts_with:
        lst = AakashCentre.objects.filter(name__contains=starts_with)
    else:
        lst = AakashCentre.objects.all()
...
def get_ac_id_list(max_results=0, starts_with=''):
    if starts_with:
        lst = AakashCentre.objects.filter(ac_id__contains=starts_with)
    else:
        lst = AakashCentre.objects.all()
    return lst
...
def get_ac_city_list(max_results=0, starts_with=''):
    if starts_with:
        lst = AakashCentre.objects.filter(city__contains=starts_with)
    else:
        lst = AakashCentre.objects.all()
    return lst
...
def get_ac_state_list(max_results=0, starts_with=''):
    if starts_with:
        lst = AakashCentre.objects.filter(state__contains=starts_with)
    else:
        lst = AakashCentre.objects.all()
    return lst
